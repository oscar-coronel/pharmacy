		...
		<div class="col-12">
			<div class="row">
				<div class="col-12 d-flex justify-content-between align-items-center">
					<h1 class="mb-0 text-primary">Listado de Proveedores</h1>
						...
						@foreach($users as $user)
							<tr>
								...
								<td class="text-center">
									<a href="{{ route('providers.edit', $user) }}" title="Editar">
								...
								<td class="text-center">
									...
									<form method="POST" action="{{ route('providers.destroy', $user) }}" class="d-none">
										@csrf @method('DELETE')
									</form>
								</td>
							</tr>
