...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('/login/images/bg-03.jpg'); background-size: 100% 100%;">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form action="{{ route('login') }}" method="POST" class="login100-form validate-form p-b-33 p-t-5">
                    @csrf
                    @error('email')
                        <div class="text-danger text-center px-3" role="alert" style="font-size: 12px;">
